...
if __name__ == "__main__":
    config_file = "D:/Pycharm Projects-win/mm_mouse/mmpose/configs/mouse/TriangNet_w48_dannce3d_256x256.py"
    ...
    for i in range(1):
        ...
        img = imshow_multiview_keypoints_3d(
            ...
            space_center=[100, 50, 50],
            kpt_score_thr=0.5,
        )
        # plt.imshow(img, interpolation='nearest')
        # plt.show()
        im = Image.fromarray(img)
        im.save(f"{results_path}/3d_scene{i}.jpeg")
