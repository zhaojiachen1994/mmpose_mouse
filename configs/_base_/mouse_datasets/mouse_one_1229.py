dataset_info = dict(
    ...
    skeleton_info={
        ...
        3: dict(link=('left_hip', 'left_foot'), id=3, color=[210, 220, 88]),
        4: dict(link=('tail_root', 'right_hip'), id=4, color=[98, 201, 211]),
        5: dict(link=('right_hip', 'right_foot'), id=5, color=[98, 201, 211]),
        ...
        11: dict(link=('neck', 'left_shoulder'), id=11, color=[187, 97, 166]),
        12: dict(link=('left_shoulder', 'left_paw'), id=12, color=[187, 97, 166]),
        13: dict(link=('neck', 'right_shoulder'), id=13, color=[109, 192, 91]),
        14: dict(link=('right_shoulder', 'right_paw'), id=14, color=[109, 192, 91]),
    },
    joint_weights=[
