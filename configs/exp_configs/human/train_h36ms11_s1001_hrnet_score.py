...
load_from = "D:/Pycharm Projects-win/mm_mouse/mmpose/work_dirs/hrnet_w48_h36m_s1_001_p17_256x256/best_PCK_epoch_120.pth"
...
data = dict(
    ...
    train=dict(
        ...
        source_data=dict(
            ...
            ann_file=f'{h36m_root}/annotations/Human36M_subject1_data_001.json',
